const CACHE='marvel-experience-v3';
const ASSETS=['./','./index.html','./style.css','./app.js','./films.json','./default_users.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
